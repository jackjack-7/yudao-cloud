...
public class OutputSaveReqVO {
    ...
    @Schema(description = "产量分布ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "5736")
    private Long id;

    @Schema(description = "矿种", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
